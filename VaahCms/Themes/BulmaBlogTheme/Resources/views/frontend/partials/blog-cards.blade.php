        ...
        <div class="columns">
            <div class="column is-three-quarters mt-6">
                <div class="columns is-multiline">
                    @if(isset($blogs['list']) && (is_array($blogs['list']) || is_object($blogs['list'])) &&
                    count($blogs['list']) > 0)
                        ...
                        <div class="card box">
                            ...
                            <div class="content">
                                <a href="{{url('/blog/'.$blog_data->permalink)}}">
                                    ...
                                    <p class="has-text-black">{!! substr(strip_tags(get_field($blog_data, 'content')),
                                        0, 250); !!}....</p>
                                </a>
                                <br />
                                <div class="level">
                                    ...
                                    <span class="level-left has-text-weight-bold" style="display: grid">
                                        ...
                                        if(isset($taxonomy_cats) && is_array($taxonomy_cats) && count($taxonomy_cats) >
                                        0){
                                        ...
                                        <a
                                            href="{{url('/taxonomies/'.$taxonomy_type[$key]->slug.'/'.$taxonomy_cat->slug)}}">
                                            {!! $taxonomy_cat->name !!}
                                        </a>
                                        @endif
                                    ...
                                    <br />
                                    <small class="level-right">{{date('d M Y - h:i A',
                                        strtotime($blog_data->created_at))}}</small>
                                </div>
                            </div>
